...
A time-boxed security review of the **protocol name** protocol was done by **ladboy233**, with a focus on the security aspects of the application's implementation.
